...
Player::Player(sf::Texture* texture, sf::RenderWindow* window, sf::Vector2u imageCount, float switchTime, float speed) : Entity(texture, window, imageCount, switchTime, speed) {
    row = 7;
    lastMovement.x = 0.0f;
    lastMovement.y = 0.0f;
}
